...
describe('changing inventory tests', function(){
    describe('addition test', function(){
        it('should be 150 when adding 50 to apple and banana', function(){
            var myInventory = convert.groceries.addToInventory(["apple", "banana"], [50, 50]);
            assert.equal(150, myInventory["apple"]);
        });
    });
    describe('subtraction test', function(){
        convert.groceries.fillArray();
        var myInventory2 = convert.groceries.subtractFromInventory(["water", "milk", "chicken"], [70, 70, 49]);
